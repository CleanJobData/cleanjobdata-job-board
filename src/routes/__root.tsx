...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Jobs Posting API for Developers | CleanJobData – Launch a Job Board" },
      {
        name: "description",
        content:
          "Jobs posting API for developers and companies building job boards. Get fresh, structured job listings via REST — no scraping. This site is a live demo.",
      },
      { property: "og:title", content: "Jobs Posting API for Developers | CleanJobData – Launch a Job Board" },
      { name: "twitter:title", content: "Jobs Posting API for Developers | CleanJobData – Launch a Job Board" },
